    ...
    <div class="panel panel-default" id="userInfo" id="homeSet">
        ...
        <div class="panel-body">
            <div class="showusersearch">
                <form class="form-inline" method="post" action="<%=basePath%>customerManager/search">
                  <div class="form-group">
                  	&nbsp;&nbsp;
                    <label for="customer_loginName">账号:</label>
                    &nbsp;&nbsp;
                    <input type="text" class="form-control" id="customer_loginName" name="username" placeholder="请输入账号" size="15px">
                  </div>
                  &nbsp;&nbsp;<!-- id="doSearch" -->
