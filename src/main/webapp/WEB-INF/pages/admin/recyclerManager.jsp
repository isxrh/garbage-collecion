...
<body>
    <div class="panel panel-default" id="userInfo" id="homeSet">
        <div class="panel-heading">
            <h3 class="panel-title">回收员管理</h3>
        </div>
        <div class="panel-body">
            <div class="showusersearch">
                <form class="form-inline" method="post" action="<%=basePath%>RecyclerManager/search">
            ...
            <div class="show-list" style="position: relative;top: 30px;">
                <table class="table table-bordered table-hover" style='text-align: center;'>
                    ...
                    <tbody id="tb">
                    	<c:forEach items="${recyclers}" var="recycler" varStatus="status">
                        <tr>
                            <td>${status.index+1}</td>
                            <td>${recycler.id}</td>
                            <td>${recycler.recyclerName}</td>
                            <td>${recycler.recyclerAccount}</td>
                            <td>${recycler.recyclerPassword}</td>
                            <td>${recycler.recyclerEmail}</td>
                            <td>${recycler.recyclerPhone}</td>
