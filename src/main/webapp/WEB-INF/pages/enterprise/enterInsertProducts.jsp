  ...
  <div class="container">
    <div class="panel panel-primary div-shadow">
      <div class="panel-body">
        <form action="<%=basePath%>enterprise/toInsertProducts" class="form-horizontal" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              <img src="<%=basePath%>assets/images/insert.jpg" alt="img" class="img-rounded" name="product_image_show" height="150">
