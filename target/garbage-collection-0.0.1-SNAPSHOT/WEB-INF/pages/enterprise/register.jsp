    ...
    <div class="container div-signin">
      <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
                <form action="<%=basePath%>recycler/regist" class="form-horizontal" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">企业照片:</label>
                            <div class="col-sm-6">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="synopsis">
                            </div>
                        </div>
                    </div>
