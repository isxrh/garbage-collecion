    ...
    <div class="container">
        <div class="panel panel-primary div-shadow">
            <div class="panel-body">
                <form action="<%=basePath%>enterprise/changeEnterInfo" class="form-horizontal" method="post">

                    <div class="form-group">
                        <label class="col-sm-3 control-label">企业名称：</label>
                        <div class="col-sm-9">
                            <input class="form-control" type="text" value=${enterpriseInfo.enterprise_name} name="enterName">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" value=${enterpriseInfo.enterprise_account} name="enterAccount">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="password" value=${enterpriseInfo.enterprise_password} name="enterPassword">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" value=${enterpriseInfo.enterprise_phone} name="enterPhone">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="text" value=${enterpriseInfo.enterprise_address} name="enterAddress">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 padding-left-0">
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-info">修&nbsp&nbsp改</button>
                            </div>
                            <div class="col-sm-4">
