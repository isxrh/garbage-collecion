    ...
    <div class="panel panel-default" id="userInfo" id="homeSet">
        ...
        <div class="panel-body">
            <div class="showusersearch">
                <form class="form-inline" method="post" action="<%=basePath%>ProductManager/search">
                  <div class="form-group">
                  	&nbsp;&nbsp;
                    <label for="customer_loginName">资源类型:</label>
                    &nbsp;&nbsp;
                    <input type="text" class="form-control" id="customer_loginName" name="username" placeholder="请输入资源类型" size="15px">
                  </div>
                  &nbsp;&nbsp;<!-- id="doSearch" -->
                ...
                <table class="table table-bordered table-hover" style='text-align: center;'>
                    ...
                    <tbody id="tb">
                        ...
                        <tr>
                            ...
                            <td>
                            	<img src="<%=basePath%>${product.product_image}"/>
                            </td>
