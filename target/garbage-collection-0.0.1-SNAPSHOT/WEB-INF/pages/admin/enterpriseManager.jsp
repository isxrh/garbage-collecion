    ...
    <div class="panel panel-default" id="userInfo" id="homeSet">
        ...
        <div class="panel-body">
            <div class="showusersearch">
                <form class="form-inline" method="post" action="<%=basePath%>EnterpriseManager/search">
                ...
                <table class="table table-bordered table-hover" style='text-align: center;'>
                    <thead>
                        <tr class="text-danger">
                            ...
                            <th class="text-center">企业名</th>
                            <th class="text-center">账号</th>
                            <th class="text-center">密码</th>
                            <th class="text-center">地址</th>
                            <th class="text-center">电话</th>
                            <th class="text-center">企业图片</th>
                            <th class="text-center">企业简介</th>
                    ...
                    <tbody id="tb">
                        ...
                        <tr>
                            ...
                            <td>${enterprise.enterprise_account}</td>
                            <td>${enterprise.enterprise_account}</td>
                            <td>${enterprise.enterprise_address}</td>
                            <td>${enterprise.enterprise_phone}</td>
                            <td>
                            	<img src="<%=basePath%>${enterprise.enterprise_image}"/>
                            </td>
                            <td>${enterprise.enterprise_introduce}</td>
